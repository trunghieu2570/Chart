...
public class LineChart extends View {
    ...
    public void drawInitialChart(Canvas canvas)
    {
        //draw name
    ...
    public int getMaxValue(String values)
    {
        int max=1;
    ...
    public void setUpData(String chartName,String timeLines,String fieldNames,String dataName,String timeName,String dataChart,int[] colors)
    {
