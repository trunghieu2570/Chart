...
public class ColumnBarChart extends Chart implements Serializable {
    ...
    public ColumnBarChart(String chartName, String description,String xAxisUnit,String yAxisUnit,String yAxisUnitMeaning,String objectMeaning) {
    ...
    public String getyAxisUnit() {return yAxisUnit;}
    public String getyAxisUnitMeaning() {return yAxisUnitMeaning;}
    public String getObjectMeaning() {return objectMeaning;}
